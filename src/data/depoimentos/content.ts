export const depoimentosContent = {
  meta: {
    ...
    description: "Histórias de vidas transformadas pelo trabalho da Caverna de Adulão.",
    ogTitle: "Depoimentos — Caverna de Adulão",
    ogDescription: "Histórias de restauração e nova vida.",
  },
  header: {
    eyebrow: "Histórias",
