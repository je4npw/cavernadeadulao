export const equipeContent = {
  meta: {
    ...
    description: "Coordenação, voluntários e conselho espiritual do Centro de Reabilitação.",
    ogTitle: "Equipe — Caverna de Adulão",
    ogDescription: "Conheça quem faz a casa acontecer.",
  },
  header: {
    eyebrow: "Quem cuida",
  ...
  team: [
    ...
    },
    {
      ...
      members: [
        { name: "Jean Patrick Wilhvock", role: "Coordenador e Responsável Técnico" },
