export const missaoContent = {
  meta: {
    title: "Missão — Caverna de Adulão",
    description:
      "Conheça a missão, a história e os valores do Centro de Reabilitação Caverna de Adulão.",
    ogTitle: "Missão — Caverna de Adulão",
    ogDescription: "Inspirados em 1 Samuel 22, acolhemos homens em situação de dependência.",
  },
  header: {
    eyebrow: "Quem somos",
    title: "Uma caverna que se tornou refúgio.",
    intro:
      "No livro de 1 Samuel, Davi se escondeu na caverna de Adulão, e ali se ajuntaram os que estavam em aperto. Esse é o nosso símbolo: um lugar que recebe os que não têm para onde ir.",
  },
  history: {
    paragraphs: [
    ...
    imageAlt: "Cruz ao pôr do sol nas montanhas",
  },
  values: {
